...
?>        
              ...
              <a href="new-bookigs.php" class="small-box-footer">More info </i></a>
            </div>
          </div>
          <!-- ./col -->
...
?>
              ...
              <a href="accepted-bookings.php" class="small-box-footer">More info </i></a>
            </div>
          </div>
...
?>
              ...
              <a href="rejected-bookings.php" class="small-box-footer">More info </i></a>
            </div>
          </div>
          <!-- ./col -->
